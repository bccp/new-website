...
Starting this year, you are able to take the [Brinson Prize Fellowship](https://www.stsci.edu/stsci-research/fellowships/brinson-prize-fellowship-program) to UC Berkeley. We also encourage you to apply to the [Hubble/Einstein](https://www.stsci.edu/stsci-research/fellowships/nasa-hubble-fellowship-program), [NSF](https://new.nsf.gov/funding/opportunities/nsf-astronomy-astrophysics-postdoctoral) and any other fellowships you may be eligible for and to take them to Berkeley!
...
UC Berkeley offers several routes for postdoctoral research in cosmology. The BCCP Fellowship is normally advertised each year through the [AAS Job Register](https://jobregister.aas.org/). Other opportunities include the [Miller Research Fellowship](https://miller.berkeley.edu/), which has an early nomination deadline, and the [Berkeley Chancellor's Postdoctoral Fellowship](https://ei.berkeley.edu/programs-services/postdoctoral). General information and resources are available from the [Berkeley Postdoctoral Association](https://postdoc.berkeley.edu/).

### Berkeley Lab postdoctoral opportunities

Berkeley Lab opportunities include the [Owen Chamberlain Fellowship](https://www.physics.lbl.gov/owen-chamberlain-fellowship/), annual cosmology postdoctoral searches advertised through the [AAS Job Register](https://jobregister.aas.org/), and the [Alvarez Fellowship](https://cs.lbl.gov/work/fellowships/alvarez-fellowship/) for research involving computational modeling, simulations, high-performance computing, and advanced data analysis. Additional information is available through Berkeley Lab's [Postdoc Resources](https://postdocresources.lbl.gov/) and the [Berkeley Lab Postdoc Association](https://postdoc.lbl.gov/).
